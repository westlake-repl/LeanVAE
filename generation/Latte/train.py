...
def main(args):
    ...
    vae = LeanVAE.load_from_checkpoint(args.vae_path, strict=False)
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, video_data in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                x = vae.encode(x).mul_(norm_param)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/ucf101/ucf101_train.yaml")
